...
const Testimonial = ({ name, role, review, image }) => {
  return (
    <div className="bg-gray-800 p-8 rounded-2xl shadow-xl relative mt-10 border border-gray-700">
      ...
      <p className="text-gray-300 italic text-center mb-6 font-light">{review}</p>
      <div className="text-center mt-auto">
        <h4 className="text-xl font-bold text-white uppercase">{name}</h4>
