...
const PlanCard = ({ title, img, desc, benefits, onApply }) => {
  return (
    <div className="bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col h-full border border-gray-700">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <p className="text-gray-300 mb-6 font-light">{desc}</p>
