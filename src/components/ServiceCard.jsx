...
const ServiceCard = ({ icon, title, description }) => {
  return (
    <div className="bg-gray-800 p-8 rounded-2xl text-center transform hover:-translate-y-2 transition-all duration-300 shadow-xl border border-gray-700 hover:border-yellow-500/50 flex flex-col items-center group">
