          ...
          <div className="w-full lg:w-2/3 space-y-12">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 transition-transform hover:-translate-y-1">
                  <div className="w-12 h-12 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center text-xl flex-shrink-0">🏢</div>
                  <span className="font-bold text-gray-900 uppercase text-sm tracking-wide">3 Successfully Owned Gyms</span>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 transition-transform hover:-translate-y-1">
                  <div className="w-12 h-12 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center text-xl flex-shrink-0">🤝</div>
                  <span className="font-bold text-gray-900 uppercase text-sm tracking-wide">7+ Managed Partner Gyms</span>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 transition-transform hover:-translate-y-1">
                  <div className="w-12 h-12 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center text-xl flex-shrink-0">👥</div>
                  <span className="font-bold text-gray-900 uppercase text-sm tracking-wide">Built Robust Team of Trainers</span>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-4 transition-transform hover:-translate-y-1">
                  <div className="w-12 h-12 bg-yellow-100 text-yellow-600 rounded-full flex items-center justify-center text-xl flex-shrink-0">📈</div>
                  <span className="font-bold text-gray-900 uppercase text-sm tracking-wide">Structured Marketing Growth</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10">
                <div className="p-8 bg-white rounded-3xl shadow-xl border border-gray-100 space-y-4">
                  <h3 className="text-xl font-bold text-gray-900 uppercase tracking-widest text-yellow-600">Vision</h3>
                ...
                <div className="p-8 bg-white rounded-3xl shadow-xl border border-gray-100 space-y-4">
                  <h3 className="text-xl font-bold text-gray-900 uppercase tracking-widest text-yellow-600">Mission</h3>
