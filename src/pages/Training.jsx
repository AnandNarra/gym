    ...
    <div className="min-h-screen bg-white overflow-x-hidden pb-20">
      ...
      <section className="relative h-[40vh] md:h-[60vh] bg-black overflow-hidden group">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-4">Our <span className="text-yellow-500">Collaboratee's</span></h1>
            <p className="text-gray-300 max-w-xl mx-auto px-4">Choose between personalized Home Training, Online Coaching, or visit our premium partner locations.</p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-200 mb-8 font-light text-sm">
                Explore our network of premium collaborator gyms and fitness locations.
              </p>
